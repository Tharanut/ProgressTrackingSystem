  ...
  return (
    <>
      ...
      <main className="mx-auto w-full max-w-4xl flex-1 px-6 py-10">
        ...
        <p className="mt-1 text-sm text-zinc-500">บันทึกเวลาทำงานจริงของคุณ (Actual Man-Day = ชั่วโมง / 8)</p>
                ...
                <tbody>
                  {myLogs.map((l) => (
                    <tr key={l.id} className="border-b border-zinc-100 last:border-0 dark:border-zinc-900">
                      ...
                      <td className="py-2 pr-4 text-zinc-600 dark:text-zinc-400">{l.task?.task_name ?? "-"}</td>
